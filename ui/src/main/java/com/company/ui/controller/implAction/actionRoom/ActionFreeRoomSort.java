...
@Singleton
public class ActionFreeRoomSort implements IAction {
    ...
    private static final Logger logger = LogManager.getLogger(ActionFreeRoomSort.class);

    public ActionFreeRoomSort() {
    }
    ...
    public void execute() {
        ...
        try {
            ...
            switch (press) {
                case 1:
                    printer.printList(serviceRoom.freeRoomSortPrice());
                    break;
                case 2:
                    printer.printList(serviceRoom.freeRoomSortStar());
                    break;
                case 3:
                    printer.printList(serviceRoom.freeRoomSortCapacity());
                    break;
                default:
